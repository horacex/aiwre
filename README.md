...
4. sharded high-throughput relay (`v1`) on Cloudflare Worker + Durable Objects
...
3. `internal/protocol`: message schema, canonicalization, signatures
...
3. trust is receiver-side verification
